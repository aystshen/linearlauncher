...
public class ShadowOverlayContainer extends ViewGroup {
    ...
    public ShadowOverlayContainer(Context context, int bg) {
        this(context, null, 0, bg);
    }
    ...
    public ShadowOverlayContainer(Context context, AttributeSet attrs, int defStyle, int bg) {
        super(context, attrs, defStyle);
        if(bg != 0) {
           // setBackgroundResource(R.drawable.bg_carousel_items);
...
//        setPivotX(mWrappedView.getWidth()/2);
//        setPivotY(mWrappedView.getHeight()/2);
